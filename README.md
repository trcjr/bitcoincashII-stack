...
```bash
BITCOINCASHII_REF=v27.0.2 docker compose build
```

The default `BITCOINCASHII_REF` in `docker-compose.yml` is pinned to `v27.0.2`. Update it there to lock all builds to a specific release.
